...
| 内容 | 说明 |
|---|---|
| `README.md` | 线定位：第三条线 = 学校课程《数据结构》跟读（不是刷题线，冲绩点/期末/408）|
| `章节计划.md` | 严蔚敏《数据结构（C语言版·第2版）》章节地图（408 主线 + 蓝桥常考对照）|
| `第1章-绪论/` | ✅ 第1章收尾：知识点/复杂度实验/蓝桥考点/练习题（已批改）+ T1/T2 模板 |
| `第2章-线性表/` | 🔄 已建（顺序表 vs 链表 / list 调库 + 手写单链表）+ T3/T4 热身 |
...
| Day 23 | 综合实战·学生成绩排行榜（类 + List + Map + 排序全家桶组装） | ✅ 作业已批改（Ex1/Ex3/Ex5 全绿；Ex2/Review 格式已代改；**Ex4 排序方向待你自己改**）|
| Day 24 | 文件与异常实战（成绩单导入导出：字符流读写 / 追加 / 异常兜底）| 🔄 已生成待练习 |
